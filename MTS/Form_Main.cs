...
namespace MTS
{
    ...
    {        
        ...
        {
            InitializeComponent();
            //connString = SqlHelper.ConnString;//连接字符串
        }
        ...
        if ((UserID == "00156") || (UserID == "264") || (UserID == "473") || (UserID=="00414"))
            {
        ...
        private void 吉时利条码打印JToolStripMenuItem_Click(object sender, EventArgs e)
        {
            frm_Keithley Frm_keithley = new frm_Keithley(UserID);
            Frm_keithley.MdiParent = this;
            Frm_keithley.Show();
        }
        ...
        private void 打印模版关联ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            frmMBSet frmMBSet = new frmMBSet(UserID);
            frmMBSet.MdiParent = this;
            frmMBSet.Show();
        }

        private void iT打印模版关联ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            frmITMBSet frmITMBSet = new frmITMBSet(UserID);
            frmITMBSet.MdiParent = this;
            frmITMBSet.Show();
        }

        private void 条码复制ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            frmSnCopy frmSnCopy = new frmSnCopy();
            frmSnCopy.MdiParent = this;
            frmSnCopy.Show();
        }
